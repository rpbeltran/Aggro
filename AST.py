...
def p_query( p ):
    '''sentence : EQUALS proposition SENTENCE_END 
                ...
                | EQUALS numeric_expression NOT numeric_expression SENTENCE_END
    '''
    if len( p ) == 6:
        p[0] = Node("__query__", [
            Node( "__not__",  [
...
def p_proposition_neg( p ):
    '''proposition : numeric_expression EQUALS NOT EQUALS numeric_expression
                   | numeric_expression EQUALS NOT numeric_expression
                   | numeric_expression NOT EQUALS numeric_expression
    '''

    if len( p ) == 6: # a equals not equals b
